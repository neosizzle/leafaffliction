...
def main():
    ...
    # Otherwise ImportError ddl will occur
    # when loading the pipeline (in predict.py)
    pipeline.named_steps["neural"].model_ = None
    pipeline.named_steps["neural"].model = None
